...
#Region "Eventos"
    ...
    Public Function CargarForm() As Boolean
        ...
        Try
            ...
            oFP.XmlData = objGlobal.leerEmbebido(Me.GetType(), "LIST_PP_CONDFRAG.xml")
    ...
    Public Function Load_Grid(ByRef objGlobal As EXO_UIAPI.EXO_UIAPI, ByRef oform As SAPbouiCOM.Form) As Boolean
        ...
        Try
            ...
            SQL = "SELECT ""FRG"".""Code"" ""Código"", ""FRG"".""Name"" ""Nombre"", ""COND"".""Code"" ""Condición"", ""COND"".""Name"" ""Descripción"", ifnull(""FRG"".""U_PP_Valor"",""FRG"".""U_PP_ValorV"") ""Valor"", ""FRG"".""U_PP_ACTIVO"" ""Activo"" "
            SQL &= " FROM ""@PP_CONDFRAG"" ""FRG"" "
            SQL &= " LEFT JOIN ""@PP_MCONDICION"" ""COND"" ON ""FRG"".""U_PP_COND""=""COND"".""Code"" "
    ...
    Private Function Lista_Tratar_Registro(ByRef ObjGlobal As EXO_UIAPI.EXO_UIAPI, ByRef oform As SAPbouiCOM.Form) As Boolean
        ...
        Try
            ...
            Select Case Accion
                Case "N" 'Nuevo
                    ObjGlobal.SBOApp.OpenForm(BoFormObjectEnum.fo_UserDefinedObject, "PP_CONDFRAG", "")
                Case "E" 'Editar
                    Try
                    ...
                    'Cargamos UDO
                    ObjGlobal.SBOApp.OpenForm(BoFormObjectEnum.fo_UserDefinedObject, "PP_CONDFRAG", ID)
                Case "D" 'Eliminar
                    Try
                        Row = oGrid.Rows.SelectedRows.Item(0, BoOrderType.ot_RowOrder)
                    Catch ex As Exception
    ...
    Public Function Eliminar_Registro(ByRef objGlobal As EXO_UIAPI.EXO_UIAPI, ByVal ID As String) As Boolean
        ...
        Try
            If objGlobal.SBOApp.MessageBox("¿Está seguro que quiere eliminar el registro?", 2, "Si", "No") = 2 Then
                Return False
            End If
            oDI_COM = New EXO_DIAPI.EXO_UDOEntity(objGlobal.refDi.comunes, "PP_CONDFRAG")

            If oDI_COM.GetByKey(ID) = False Then
                objGlobal.SBOApp.MessageBox("El registro con clave " & ID & " no se encontró en Relación de Condiciones y fragmentos de la BBDD!")
                Return False
            Else
                If oDI_COM.UDO_Delete(ID) = False Then
                    objGlobal.SBOApp.MessageBox("El registro con clave " & ID & " no se pudo eliminar Relación de Condiciones y fragmentos :" & oDI_COM.GetLastError)
                    Return False
                End If
            End If
