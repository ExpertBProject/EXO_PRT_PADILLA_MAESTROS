...
#Region "Inicialización"
    ...
    Private Sub cargaCampos()
        ...
        '    sXML = objGlobal.funciones.leerEmbebido(Me.GetType(), "UDO_PP_CHAPAS_FR1.xml")
        '    objGlobal.SBOApp.StatusBar.SetText("Validando: UDO_PP_CHAPAS_FR1", SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Success)
        ...
        Try
            ...
            Else
                ...
                Select Case infoEvento.MenuUID
                    Case "PP-MnRCCHA"
                        'Cargamos UDO
                        objGlobal.SBOApp.OpenForm(BoFormObjectEnum.fo_UserDefinedObject, "PP_CHAPAS_FR1", "")
                End Select
            End If
                        ...
                        Select Case oForm.ChooseFromLists.Item(oDataTable.ChooseFromListUID).ObjectType
                            Case "PP_CHAPA"
                                Try
                                    ...
                                    oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR1").SetValue("Name", 0, sDes)
                                Catch ex As Exception
                                    oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR1").SetValue("Code", 0, sCod)
                                    oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR1").SetValue("Name", 0, sDes)
                                End Try
                            Case "PP_LCONDICION"
                                Try
                                    ...
                                    oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").SetValue("U_PP_CONDNAME", oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").Offset, sDes)
                                Catch ex As Exception
                                    oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").SetValue("U_PP_CONDICION", oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").Offset, sCod)
                                    oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").SetValue("U_PP_CONDNAME", oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").Offset, sDes)
                                End Try
                            Case "PP_FRAGMENTOS"
                                Try
                                    ...
                                    oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").SetValue("U_PP_FRAGNAME", oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").Offset, sDes)
                                Catch ex As Exception
                                    oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").SetValue("U_PP_FRAGMENTO", oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").Offset, sCod)
                                    oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").SetValue("U_PP_FRAGNAME", oForm.DataSources.DBDataSources.Item("@PP_CHAPAS_FR2").Offset, sDes)
                                End Try
                        End Select
