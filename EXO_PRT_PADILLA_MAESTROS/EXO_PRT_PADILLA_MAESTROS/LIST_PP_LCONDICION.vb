...
Public Class LIST_PP_LCONDICION
...
#Region "Eventos"
    ...
    Public Function CargarForm() As Boolean
        ...
        Try
            ...
            oFP.XmlData = objGlobal.leerEmbebido(Me.GetType(), "LIST_PP_LCONDICION.xml")
    ...
    Public Function Load_Grid(ByRef objGlobal As EXO_UIAPI.EXO_UIAPI, ByRef oform As SAPbouiCOM.Form) As Boolean
        ...
        Try
            ...
            SQL = "SELECT ""Code"" ""Código"", ""Name"" ""Nombre"", ""U_PP_ACTIVO"" ""Activo"" "
            SQL &= " FROM ""@PP_LCONDICION"" "
    ...
    Private Function Lista_Tratar_Registro(ByRef ObjGlobal As EXO_UIAPI.EXO_UIAPI, ByRef oform As SAPbouiCOM.Form) As Boolean
        ...
        Try
            ...
            Select Case Accion
                Case "N" 'Nuevo
                    ObjGlobal.SBOApp.OpenForm(BoFormObjectEnum.fo_UserDefinedObject, "PP_LCONDICION", "")
                Case "E" 'Editar
                    Try
                    ...
                    'Cargamos UDO
                    ObjGlobal.SBOApp.OpenForm(BoFormObjectEnum.fo_UserDefinedObject, "PP_LCONDICION", ID)
                Case "D" 'Eliminar
                    Try
                        Row = oGrid.Rows.SelectedRows.Item(0, BoOrderType.ot_RowOrder)
                    Catch ex As Exception
    ...
    Public Function Eliminar_Registro(ByRef objGlobal As EXO_UIAPI.EXO_UIAPI, ByVal ID As String) As Boolean
        ...
        Try
            If objGlobal.SBOApp.MessageBox("¿Está seguro que quiere eliminar el registro?", 2, "Si", "No") = 2 Then
                Return False
            End If
            oDI_COM = New EXO_DIAPI.EXO_UDOEntity(objGlobal.refDi.comunes, "PP_LCONDICION")

            If oDI_COM.GetByKey(ID) = False Then
                objGlobal.SBOApp.MessageBox("El registro con clave " & ID & " no se encontró en la lista de condiciones de la BBDD!")
                Return False
            Else
                If oDI_COM.UDO_Delete(ID) = False Then
                    objGlobal.SBOApp.MessageBox("El registro con clave " & ID & " no se pudo eliminar la lista de condiciones:" & oDI_COM.GetLastError)
                    Return False
                End If
            End If
